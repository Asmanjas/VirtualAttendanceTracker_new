...
public class Friday extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnnext = (Button)findViewById(R.id.next_button_friday) ;
        ...
        Intent xk = getIntent();
        email_holder = xk.getStringExtra("email_fri");


        // Spinner element
        spinner1 = (Spinner) findViewById(R.id.spinner1_fri);
        spinner2 = (Spinner) findViewById(R.id.spinner2_fri);
        spinner3 = (Spinner) findViewById(R.id.spinner3_fri);
        spinner4 = (Spinner) findViewById(R.id.spinner4_fri);
        ...
        ts1 = (TextView)findViewById(R.id.time_start1_fri);
        ts2 = (TextView)findViewById(R.id.time_start2_fri);
        ts3 = (TextView)findViewById(R.id.time_start3_fri);
        ts4 = (TextView)findViewById(R.id.time_start4_fri);
        ...
        te1 = (TextView)findViewById(R.id.time_end1_fri);
        te2 = (TextView)findViewById(R.id.time_end2_fri);
        te3 = (TextView)findViewById(R.id.time_end3_fri);
        te4 = (TextView)findViewById(R.id.time_end4_fri);
        ...
        class InsertIntoTableClass extends AsyncTask<String,Void,String > {
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if(httpResponseMsg=="") {
                    ...
                    Toast.makeText(Friday.this,httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
