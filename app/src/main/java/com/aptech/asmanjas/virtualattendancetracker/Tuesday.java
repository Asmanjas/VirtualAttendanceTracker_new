...
public class Tuesday extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnnext = (Button)findViewById(R.id.next_button_tue) ;
        btnnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(email_holder=="initial"){
                    ...
                    Intent x = new Intent(Tuesday.this, Wednesday.class);
                    x.putExtra("email_wed", email_holder);
                    startActivity(x);
                }
            }
        });
        ...
        Intent xk = getIntent();
        email_holder = xk.getStringExtra("email_tue");


        // Spinner element
        spinner1 = (Spinner) findViewById(R.id.spinner1_tue);
        spinner2 = (Spinner) findViewById(R.id.spinner2_tue);
        spinner3 = (Spinner) findViewById(R.id.spinner3_tue);
        spinner4 = (Spinner) findViewById(R.id.spinner4_tue);
        ...
        ts1 = (TextView)findViewById(R.id.time_start1_tue);
        ts2 = (TextView)findViewById(R.id.time_start2_tue);
        ts3 = (TextView)findViewById(R.id.time_start3_tue);
        ts4 = (TextView)findViewById(R.id.time_start4_tue);
        ...
        te1 = (TextView)findViewById(R.id.time_end1_tue);
        te2 = (TextView)findViewById(R.id.time_end2_tue);
        te3 = (TextView)findViewById(R.id.time_end3_tue);
        te4 = (TextView)findViewById(R.id.time_end4_tue);
   ...
   /* private void updateTextLabel5(){
    ...
    private void updateTextLabel10(){
        ...
        InsertIntoTable(email_holder, "Tuesday", label, time_startx2, time_endx2, HttpUrl);
    ...
    private void updateTextLabel9(){
        ...
        InsertIntoTable(email_holder, "Tuesday", label, time_startx1, time_endx1, HttpUrl);
    ...
    private void updateTextLabel11(){
        ...
        InsertIntoTable(email_holder, "Tuesday", label, time_startx3, time_endx3, HttpUrl);
    ...
    private void updateTextLabel12(){
        ...
        InsertIntoTable(email_holder, "Tuesday", label, time_startx4, time_endx4, HttpUrl);
        ...
        class InsertIntoTableClass extends AsyncTask<String,Void,String > {
            ...
            protected void onPostExecute(String httpResponseMsg) {
                ...
                if(httpResponseMsg=="") {
                    ...
                    Toast.makeText(Tuesday.this,httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
